---
description: >-
  Audits a zkML codebase against the paper-analyst's claim list, looking
  for places the implementation does not match what the paper says.
  Receives the paper manifest and produces audit findings. Triggers:
  "inspect codebase", "audit code", "verify implementation",
  "code analysis".
tools: [read, search]
